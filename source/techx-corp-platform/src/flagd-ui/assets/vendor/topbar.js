...
(function (window, document) {
  "use strict";
  var canvas, currentProgress, showing,
    progressTimerId = null, fadeTimerId = null, delayTimerId = null,
    ...
    repaint = function () {
      ...
      for (var stop in options.barColors) gradient.addColorStop(stop, options.barColors[stop]);
